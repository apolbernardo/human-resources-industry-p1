...
## Project Overview
This project analyzes the responses of the surveys from the employees regarding their personal experiences working in the company. 
...
- **Overall Satisfaction vs. Specific Pain Points:** – While some employees are generally satisfied, issues like unequal workload distribution, unclear responsibilities, or insufficient recognition can lower satisfaction rates in specific areas.

## How to Run
Open the notebook in Google Colab or Jupyter to explore the analysis
